...
PROJECT_ROOT=/Users/amedhi/Projects/Codes/DiagQuadratic
...
CXX=clang++ -std=c++17 # Clang compiler 
#CXX=g++ -std=c++11 # GNU GCC compiler

ifeq ($(MPI), HAVE_BOOST_MPI)
  CXX=/opt/openmpi/bin/mpicxx -std=c++17
  CPPFLAGS=-D$(MPI)
else
  CPPFLAGS=
endif
...
OPTFLAGS= -Wall -O3
#OPTFLAGS=-Wall -pg
#OPTFLAGS=-DDEBUG_MODE -g -O0 -Wall -pedantic
...
ifeq ($(MPI), HAVE_BOOST_MPI)
  ...
  BOOST_LDFLAGS=-L/usr/local/lib -Wl,-rpath, /usr/local/lib
else 
