...
* @Last Modified time: 2024-06-12 23:07:10
*----------------------------------------------------------------------------*/
#include <iostream>
#include <stdexcept>
#include <set>
...
void ProjectionOp::set(const value_type& type0)
{
  this->clear();
...
void ProjectionOp::set(const value_type& type0, const value_type& type1, const value_type& type2)
{
  this->clear();
  super_type::insert(type0);
  super_type::insert(type1);
