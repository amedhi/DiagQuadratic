...
enum class op_id {
  ni_sigma, ni, cdagc_up, cdagc_dn, cdagc_sigma, sisj, sisj_plus, spin_flip, 
...
public:
  ...
  ~ProjectionOp() {}
  void set(const value_type& type0);
  void set(const value_type& type0, const value_type& type1);
  void set(const value_type& type0, const value_type& type1, const value_type& type2);
  void set(const value_type& type0, const value_type& type1, const value_type& type2,
               const value_type& type3);
  void set(const value_type& type0, const value_type& type1, const value_type& type2,
               const value_type& type3, const value_type& type4);
  void set(const value_type& type0, const value_type& type1, const value_type& type2,
               const value_type& type3, const value_type& type4, const value_type& type5);
  void clear(void); 
